...
(function($global) {
  ...
  ash_core_ComponentMatchingFamily.__name__ = [
    "ash",
    "core",
  ...
  ash_core_ComponentMatchingFamily.prototype = {
    ...
    addIfMatch: function(entity) {
      if (this.entities.h.__keys__[entity.__id__] == null) {
        ...
        var componentClass = new haxe_ds__$StringMap_StringMapIterator(
          _this,
          _this.arrayKeys()
        );
        ...
        var componentClass2 = new haxe_ds__$StringMap_StringMapIterator(
          _this1,
          _this1.arrayKeys()
        );
        while (componentClass2.hasNext()) {
          ...
          node[
            __map_reserved[key] != null
              ? _this2.getReserved(key)
              : _this2.h[key]
          ] = entity.get(componentClass3);
        }
    ...
    removeIfMatch: function(entity) {
      if (this.entities.h.__keys__[entity.__id__] != null) {
        ...
        if (this.engine.updating) {
          ...
          this.engine.updateComplete.add(
            $bind(this, this.releaseNodePoolCache)
          );
        } else {
  ...
  ash_core_Engine.prototype = {
    addEntity: function(entity) {
      ...
      if (
        ...
        throw new js__$Boot_HaxeError(
          "The entity name " +
            entity.name +
            " is already in use by another entity."
        );
      }
      ...
      var family = new haxe_ds__$StringMap_StringMapIterator(
        _this2,
        _this2.arrayKeys()
      );
    ...
    entityNameChanged: function(entity, oldName) {
      var _this = this.entityNames;
      if (
        (__map_reserved[oldName] != null
          ? _this.getReserved(oldName)
          : _this.h[oldName]) == entity
      ) {
    ...
    getNodeList: function(nodeClass) {
      ...
      if (
        ...
        return (__map_reserved[key1] != null
  ...
  ash_core_Entity.prototype = {
    ...
    remove: function(componentClass) {
      ...
      var key = Type.getClassName(componentClass);
      var component =
        __map_reserved[key] != null ? _this.getReserved(key) : _this.h[key];
      if (component != null) {
        var _this1 = this.components;
        var name = Type.getClassName(componentClass);
    ...
    getAll: function() {
      var componentArray = [];
      var _this = this.components.valueMap;
      var component = new haxe_ds__$StringMap_StringMapIterator(
        _this,
        _this.arrayKeys()
      );
  ...
  ash_core_NodePool.prototype = {
    ...
    dispose: function(node) {
      var _this = this.components.valueMap;
      var componentName = new haxe_ds__$StringMap_StringMapIterator(
        _this,
        _this.arrayKeys()
      );
  ...
  ash_signals_ListenerNodePool.__name__ = [
    "ash",
    "signals",
    "ListenerNodePool"
  ];
  ...
  var ash_tools_ListIteratingSystem = function(
    nodeClass,
    nodeUpdateFunction,
    nodeAddedFunction,
    nodeRemovedFunction
  ...
  ash_tools_ListIteratingSystem.__name__ = [
    "ash",
    "tools",
    "ListIteratingSystem"
  ];
  ...
  game_AudioManager.preload = function(game1) {
    ...
    while (name.hasNext()) {
      var name1 = name.next();
      game1.load.audio(name1, url + "data/audio/" + name1 + ".ogg");
    }
  };
  ...
  game_ControlSystem.prototype = $extend(ash_core_System.prototype, {
    addToEngine: function(engine) {
      ...
      this.playerSprite.body.onWorldBounds.add(
        $bind(this, this.hitWorldBounds),
        this
      );
    },
    removeFromEngine: function(engine) {
    ...
    update: function(dt) {
      this.phaserGame.physics.arcade.collide(
        this.playerSprite,
        this.blockSprites,
        $bind(this, this.onCollide)
      );
      if (this.mouseEnabled) {
        var mouseCoords = whiplash_Input.mouseCoordinates;
        var mx =
          this.phaserGame.camera.x +
          (mouseCoords.x * 320) / $("canvas").width();
        ...
        if (this.jumping) {
          if (
            this.jumpTime < game_Config.jumpMaxTime &&
            whiplash_Input.mouseButtons.h[0]
          ) {
            playerBody.velocity.y = game_Config.jumpVelocity;
          } else {
            this.jumping = false;
    ...
    render: function() {
      var _this = whiplash_Input.keys;
      if (
        __map_reserved["F2"] != null ? _this.getReserved("F2") : _this.h["F2"]
      ) {
  ...
  game_Factory.preload = function(game1) {
    game1.load.image("super-mario", url + "data/textures/super-mario.png");
    game1.load.image("sky", url + "data/textures/blue-sky.png");
    game1.load.tilemap(
      "level",
      url + "data/tilemaps/level.json",
      null,
      Phaser.Tilemap.TILED_JSON
    );
    game1.load.atlas(
      "mario-sprites",
      url + "data/textures/mario-sprites.png",
      url + "data/textures/mario-sprites.json"
    );
    game1.load.spritesheet(
      "level-sheet",
      url + "data/textures/super-mario.png",
    ...
    game1.load.bitmapFont(
      "font",
      url + "data/fonts/font.png",
      url + "data/fonts/font.fnt"
    );
  };
  ...
  game_Factory.createBlocks = function(input) {
    ...
    while (i >= 0) {
      ...
      var y =
        (game_Config.height - game_Config.firstRow) * game_Config.blockSize -
        p * game_Config.lineSpacing * game_Config.blockSize;
      var advance = 0;
      var isHidden = false;
      var _g1 = 0;
      ...
      while (_g1 < _g) {
        ...
        switch ($char) {
          ...
          default:
            var e = isHidden
              ? game_Factory.createQuestionBlock($char)
              : game_Factory.createLetterBlock($char);
            e.get(whiplash_phaser_Transform).position.set(
              x + advance * game_Config.blockSize,
              y
            );
            result.push(e);
            ++advance;
  ...
  var game_Game = function() {
    ...
    $(window).on("load", null, function() {
      whiplash_Lib.init(320, 240, ".root", {
        preload: $bind(_gthis, _gthis.preload),
        create: $bind(_gthis, _gthis.create),
        update: $bind(_gthis, _gthis.update),
        render: $bind(_gthis, _gthis.render)
      });
  ...
  game_Game.prototype = {
    ...
    create: function() {
      ...
      var es = game_Factory.createBlocks(
        $global.window.message || "debugging\n[session]"
      );
      var _g = 0;
      while (_g < es.length) {
        var e3 = es[_g];
  ...
  var game_QuestionSystem = function() {
    this.blockSprites = [];
    ash_tools_ListIteratingSystem.call(
      this,
      game_QuestionNode,
      $bind(this, this.updateNode),
      $bind(this, this.onNodeAdded),
  ...
  game_QuestionSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      addToEngine: function(engine) {
        ash_tools_ListIteratingSystem.prototype.addToEngine.call(this, engine);
        this.engine = engine;
        this.phaserGame = whiplash_Lib.phaserGame;
        this.playerSprite = engine.entityNames
          .get("player")
          .get(whiplash_phaser_Sprite);
        var _g_current = this.nodeList.head;
        while (_g_current != null) {
          var node = _g_current;
          _g_current = _g_current.next;
      ...
      removeFromEngine: function(engine) {
        ash_tools_ListIteratingSystem.prototype.removeFromEngine.call(
          this,
          engine
        );
      },
  ...
  game_ShakeSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      addToEngine: function(engine) {
        ash_tools_ListIteratingSystem.prototype.addToEngine.call(this, engine);
    ...
    while (_g1 < _g) {
      ...
      if (g != null) {
        if (value > 0) {
          if (
            g.axes[a] >= value &&
            whiplash_Input.previousGamepadAxes[i][a] < value
          ) {
            return true;
          }
        } else if (value < 0) {
  ...
  whiplash_Input.isButtonJustPressed = function(button) {
    ...
    while (_g1 < _g) {
      ...
      if (
        g != null &&
        g.buttons[b].pressed &&
        !whiplash_Input.previousGamepadButtons[i][b]
      ) {
        return true;
      }
    }
  ...
  whiplash_Lib.init = function(
    ...
    whiplash_Lib.phaserGame = new Phaser.Game(
      width,
      height,
      Phaser.CANVAS,
      parentElement,
    ...
    whiplash_Lib.getDeltaTime = function() {
      return whiplash_Lib.phaserGame.time.elapsed * 0.001;
    };
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_GroupSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_SpriteSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_TileSpriteSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_TilemapLayerSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_TextSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_BitmapTextSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_GraphicsSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
    whiplash_Lib.ashEngine.addSystem(
      new whiplash_phaser_EmitterSystem(whiplash_Lib.phaserGame),
      systemsPriority
    );
  };
  var whiplash_common_components_Active = function() {};
  whiplash_common_components_Active.__name__ = [
    "whiplash",
    "common",
    "components",
    "Active"
  ...
  whiplash_math__$Point_Point_$Impl_$.__name__ = [
    "whiplash",
    "math",
    "_Point",
    "Point_Impl_"
  ...
  whiplash_math__$Vector2_Vector2_$Impl_$.__name__ = [
    "whiplash",
    "math",
    "_Vector2",
    "Vector2_Impl_"
  ...
  whiplash_phaser_BitmapTextNode.__name__ = [
    "whiplash",
    "phaser",
    "BitmapTextNode"
  ];
  ...
  var whiplash_phaser_BitmapTextSystem = function(game) {
    ash_tools_ListIteratingSystem.call(
      this,
      whiplash_phaser_BitmapTextNode,
      $bind(this, this.updateNode),
      $bind(this, this.onNodeAdded),
      $bind(this, this.onNodeRemoved)
    );
  ...
  whiplash_phaser_BitmapTextSystem.__name__ = [
    "whiplash",
    "phaser",
    "BitmapTextSystem"
  ];
  whiplash_phaser_BitmapTextSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_BitmapTextSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
  ...
  var whiplash_phaser_Emitter = function(maxParticles) {
    Phaser.Particles.Arcade.Emitter.call(
      this,
      whiplash_Lib.phaserGame,
      0,
      0,
  ...
  whiplash_phaser_Emitter.prototype = $extend(
  ...
  whiplash_phaser_EmitterSystem.__name__ = [
    "whiplash",
    "phaser",
    "EmitterSystem"
  ];
  whiplash_phaser_EmitterSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_EmitterSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_GraphicsNode.__name__ = [
    "whiplash",
    "phaser",
    "GraphicsNode"
  ];
  ...
  whiplash_phaser_GraphicsSystem.__name__ = [
    "whiplash",
    "phaser",
    "GraphicsSystem"
  ];
  whiplash_phaser_GraphicsSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_GraphicsSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_GroupSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_SpriteSystem.__name__ = [
    "whiplash",
    "phaser",
    "SpriteSystem"
  ];
  whiplash_phaser_SpriteSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_SpriteSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_TextSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_TileSpriteNode.__name__ = [
    "whiplash",
    "phaser",
    "TileSpriteNode"
  ];
  ...
  var whiplash_phaser_TileSpriteSystem = function(game) {
    ash_tools_ListIteratingSystem.call(
      this,
      whiplash_phaser_TileSpriteNode,
      $bind(this, this.updateNode),
      $bind(this, this.onNodeAdded),
      $bind(this, this.onNodeRemoved)
    );
  ...
  whiplash_phaser_TileSpriteSystem.__name__ = [
    "whiplash",
    "phaser",
    "TileSpriteSystem"
  ];
  whiplash_phaser_TileSpriteSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_TileSpriteSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {
        var transform = node.transform;
  ...
  whiplash_phaser_TilemapLayer.__name__ = [
    "whiplash",
    "phaser",
    "TilemapLayer"
  ];
  whiplash_phaser_TilemapLayer.__super__ = Phaser.TilemapLayer;
  whiplash_phaser_TilemapLayer.prototype = $extend(
  ...
  whiplash_phaser_TilemapLayerNode.__name__ = [
    "whiplash",
    "phaser",
    "TilemapLayerNode"
  ];
  ...
  whiplash_phaser_TilemapLayerNode.prototype = $extend(
    ash_core_Node.prototype,
    {
  ...
  var whiplash_phaser_TilemapLayerSystem = function(game) {
    ash_tools_ListIteratingSystem.call(
      this,
      whiplash_phaser_TilemapLayerNode,
      $bind(this, this.updateNode),
      $bind(this, this.onNodeAdded),
      $bind(this, this.onNodeRemoved)
    );
  ...
  whiplash_phaser_TilemapLayerSystem.__name__ = [
    "whiplash",
    "phaser",
    "TilemapLayerSystem"
  ];
  whiplash_phaser_TilemapLayerSystem.__super__ = ash_tools_ListIteratingSystem;
  whiplash_phaser_TilemapLayerSystem.prototype = $extend(
    ash_tools_ListIteratingSystem.prototype,
    {
      updateNode: function(node, dt) {},
      onNodeAdded: function(node) {
  ...
  whiplash_Input.previousGamepadAxes = [
    whiplash_Input.nullAxes,
    whiplash_Input.nullAxes,
    whiplash_Input.nullAxes,
    whiplash_Input.nullAxes
  ];
