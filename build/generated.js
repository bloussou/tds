...
game_Factory.preload = function(game1) {
	...
	game1.load.tilemap("level",url+"data/tilemaps/level.json",null,Phaser.Tilemap.TILED_JSON);
	game1.load.atlas("mario-sprites",url+"data/textures/mario-sprites.png",url+"data/textures/mario-sprites.json");
	game1.load.spritesheet("level-sheet",url+"data/textures/super-mario.png",game_Config.blockSize,game_Config.blockSize,128,1,2);
	game1.load.bitmapFont("font",url+"data/fonts/font.png",url+"data/fonts/font.fnt");
};
